...
Confiant dans tes capacités : il te recrute ! Félicitations. À toi les pépètes et la gloire  💰️💸️🌟️ !!  Mais maintenant il va falloir assurer.

Aujourd'hui c'est donc ton premier jour de taf. Et là... tu découvres l'horreur. Un code franchement pas pro, voir limite hors jeu. Et le coverage ?
Ouais... en fait il est à 0.
C'est du [pending test](https://relishapp.com/rspec/rspec-core/v/2-0/docs/pending/pending-examples)... Les dévs de la boîte ont bien marqué ce qu'il fallait tester. Mais n'ont pas écrit les tests.
...
Bien sûr : tu as le droit de toucher au Gemfile. Mais pas de charger un nouveau framework de test. Chez Bürgerroy, on n’est pas des caramels mous : on veut du RSpec natif.
...
Oui tous les dévs de la boîte vous le diront : ça marche très bien chez eux...
